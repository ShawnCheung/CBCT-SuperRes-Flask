...
class MedicalCycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--downsample_loss', type=float, default=0, help='downsample_loss')
            parser.add_argument('--upsample_loss', type=float, default=0, help='upsample_loss')
